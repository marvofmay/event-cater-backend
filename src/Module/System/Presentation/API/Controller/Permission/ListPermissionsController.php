...
namespace App\Module\System\Presentation\API\Controller\Permission;
...
final class ListPermissionsController extends AbstractController
{
    ...
    #[Route(path: '/api/permissions', name: 'api.permissions.list', methods: ['GET'])]
    public function __invoke(): JsonResponse
    {
        ...
        try {
            $data = $this->queryBus->dispatch(new ListPermissionsQuery())
