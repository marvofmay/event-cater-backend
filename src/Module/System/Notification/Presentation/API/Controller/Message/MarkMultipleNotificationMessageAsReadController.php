...
use App\Module\System\Notification\Application\DTO\MarkAsReadMultipleDTO;
...
final class MarkMultipleNotificationMessageAsReadController extends AbstractController
{
    ...
    #[Route(
        ...
        name: 'api.notifications.mark_as_read_multiple',
        methods: ['PATCH']
    )]
    public function __invoke(#[MapRequestPayload] MarkAsReadMultipleDTO $dto): JsonResponse
    {
        ...
        try {
            $this->commandBus->dispatch(
                new MarkAsReadMultipleNotificationsCommand($dto->notificationsUUIDs)
            );
