...
final class DeleteNotificationMessageController extends AbstractController
{
     ...
     */
    #[Route(
        path: '/api/notification-messages/{uuid}',
        name: 'api.notification_messages.delete',
    ...
    public function __invoke(string $uuid): Response
    {
        ...
        try {
            $this->commandBus->dispatch(new DeleteNotificationCommand($uuid));
        } catch (HandlerFailedException $e) {
            throw $e->getPrevious() ?? $e;
        }

        return new JsonResponse(
            ['message' => $this->messageService->get('notification.delete.success', [], 'notifications')],
            Response::HTTP_OK
        );
    }
}
