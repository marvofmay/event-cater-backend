...
final class ChangeEmployeeAddressCommandHandler extends CommandHandlerAbstract
{
    ...
    public function __invoke(ChangeEmployeeAddressCommand $command): void
    {
        ...
        $employeeAggregate->changeAddress(
